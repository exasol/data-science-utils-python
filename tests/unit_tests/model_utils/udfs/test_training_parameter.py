...
@pytest.mark.parametrize(
    ...
    [
        (1, 2, 3, True, 4, [ColumnName("abc")]),
        (1, 2, 3, True, None, [ColumnName("abc")]),
        (1, 2, 3, True, None, []),
    ]
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (1, 2, 3, True, 4, "None"),
        (1, 2, 3, True, 4, [None]),
        (1, 2, 3, None, 4, [ColumnName("abc")]),
        (1, 2, None, True, 4, [ColumnName("abc")]),
        (1, None, 3, True, 4, [ColumnName("abc")]),
        (None, 2, 3, True, 4, [ColumnName("abc")]),
        ("1", 2, 3, True, 4, [ColumnName("abc")]),
        (1, "2", 3, True, 4, [ColumnName("abc")]),
        (1, 2, "3", True, 4, [ColumnName("abc")]),
        (1, 2, 3, "True", 4, [ColumnName("abc")]),
